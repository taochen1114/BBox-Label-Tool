...
class LabelTool():
    def __init__(self, master):
        ...
        self.btnclass = Button(self.frame, text = 'ConfirmClass', command = self.setClass, bg='red')
...
##            return
    ...
    def clearBBox(self):
        ...
        self.bboxIdList = []
        self.bboxList = []
        self.btnClear.configure(bg="blue")
    ...
    def setClass(self):
    	...
    	self.btnclass.configure(bg="blue")
    	# print('color')
